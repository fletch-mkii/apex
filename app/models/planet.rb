class Planet < ActiveRecord::Base
  ...
  ATTRIBUTE_INFO = {
    planet_temperature: "This is the absolute surface temperature of the planet,
    ...
    planet_orbital_period: "Orbital period is the amount of time, in days, that it
                          ...
                          90,000 days!",
    planet_orbital_eccentricity: "A planet's orbital eccenticity is a measure of
    ...
    planet_mass: "The amount of matter contained within the planet.  The mass of
    ...
    planet_radius: "The radius of a planet is the distance from the center to the
                  ...
                  simple arithmetic.",
    planet_density: "The density of a planet is how much mass is contained in a
                    given volume.  This value is trivially calculated if the mass
                    and radius are known, but is otherwise fairly impossible to
                    figure out.",
    planet_discovery_method: "There are three main methods for discovering exoplanets.
